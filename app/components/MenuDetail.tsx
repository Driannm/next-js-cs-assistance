...
export default function MenuDetail({
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent
        side="bottom"
        className="h-[90vh] rounded-t-3xl p-0 overflow-hidden flex flex-col border-none focus:outline-none"
      >
        ...
        <div className="relative h-72 w-full shrink-0">
          ...
          <div className="absolute bottom-4 left-6 right-6">
            <span className="bg-pink-400 text-white text-[10px] font-bold px-2 py-1 rounded-md mb-2 inline-block shadow-sm">
              {menu.category}
            </span>
