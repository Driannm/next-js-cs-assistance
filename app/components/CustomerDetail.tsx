                ...
                {customer.orders.map((order) => {
                  ...
                  return (
                    <div key={order.id} className="relative group">
                      {/* Dot Timeline */}
                      <div className={`absolute -left-[21px] top-1 w-2.5 h-2.5 rounded-full border-2 border-white ring-1 ring-gray-200 ${order.status === 'sent' ? 'bg-green-400' : 'bg-gray-300'}`} />
                      ...
                      <div className="flex flex-col gap-1">
                        <div className="flex justify-between items-center">
                          ...
                          <span className={`text-[10px] px-2 py-0.5 rounded-full flex items-center gap-1 font-bold ${statusColor}`}>
